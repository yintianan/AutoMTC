...
class Model(nn.Module):
    def __init__(self, genotype, num_classes=10, C=4, stem_multiplier=2, layers=4,steps=5):
...
class Network(nn.Module):
    def __init__(self, genotype, num_classes=10, C=4, stem_multiplier=2, layers=4,steps=5):
        ...
        self.model1 = Model( genotype, num_classes=10, C=4, stem_multiplier=2, layers=4,steps=5)
        self.model2 = Model( genotype, num_classes=10, C=4, stem_multiplier=2, layers=4,steps=5)
